INSERT INTO TERMO (termo, significado, tag) VALUES
  ('teste', 'processo controlado e previsível voltado à observação, sem expectativa de sucesso', 'teste'),
  ('comando', 'instrução a ser executada de acordo com as regras de sua linguagem', 'ilc'),
